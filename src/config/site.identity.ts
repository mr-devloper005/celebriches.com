export const siteIdentity = {
  code: process.env.NEXT_PUBLIC_SITE_CODE || 'celebriches',
  name: process.env.NEXT_PUBLIC_SITE_NAME || 'Celebriches',
  ...
  domain: process.env.NEXT_PUBLIC_SITE_DOMAIN || 'celebriches.com',
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://celebriches.com',
