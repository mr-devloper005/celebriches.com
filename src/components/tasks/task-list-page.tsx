...
const variantShells = {
  'listing-directory':
    'bg-[radial-gradient(circle_at_top_left,oklch(0.55_0.08_220/0.1),transparent_26%),linear-gradient(180deg,var(--background)_0%,oklch(0.99_0.005_230)_100%)]',
  'listing-showcase': 'bg-gradient-to-b from-muted/40 to-background',
  'article-editorial':
    'bg-[radial-gradient(circle_at_top_left,oklch(0.8_0.138_82/0.1),transparent_24%),linear-gradient(180deg,var(--background)_0%,oklch(0.98_0.008_225)_100%)]',
  'article-journal': 'bg-gradient-to-b from-muted/45 to-background',
  'image-masonry': 'bg-[linear-gradient(180deg,oklch(0.14_0.04_265)_0%,oklch(0.18_0.045_270)_100%)] text-white',
  'image-portfolio': 'bg-[linear-gradient(180deg,oklch(0.12_0.045_270)_0%,oklch(0.16_0.04_265)_100%)] text-white',
  'profile-creator': 'bg-[linear-gradient(180deg,oklch(0.14_0.04_265)_0%,oklch(0.18_0.045_270)_100%)] text-white',
  'profile-business': 'bg-gradient-to-b from-muted/35 to-background',
  'classified-bulletin': 'bg-gradient-to-b from-muted/50 to-background',
  'classified-market': 'bg-gradient-to-b from-muted/40 to-background',
  'sbm-curation': 'surface-task-sbm',
  'sbm-library': 'bg-gradient-to-b from-muted/35 to-background',
} as const
  ...
  const ui = isDark
    ...
    : layoutKey.startsWith('article') || layoutKey.startsWith('sbm')
      ? {
          ...
          panel: 'border border-border/80 bg-card/95 shadow-sm backdrop-blur-sm',
          soft: 'border border-border/70 bg-muted/45',
          input: 'border border-border bg-background text-foreground rounded-xl',
          button: 'rounded-full bg-primary text-primary-foreground shadow-md shadow-primary/15 hover:bg-primary/90',
        }
      : {
