...
export function NavbarAuthControls() {
  ...
  return (
    <>
      ...
      <Button variant="ghost" size="icon" onClick={logout} className="rounded-full text-[#5f4750] hover:bg-[rgba(110,26,55,0.06)] hover:text-[#8f1f3f]" title="Sign Out">
        <Avatar className="h-9 w-9 border border-[rgba(110,26,55,0.12)] cursor-pointer">
